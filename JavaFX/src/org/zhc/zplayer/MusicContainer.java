...
public class MusicContainer implements EventHandler<ActionEvent>,LoadOver{
  ...
  Menu buildGroupMenu(String group){
    ...
    Menu menu=MenuBuilder.create()
	  .items(new_group=new MenuItem("   新建列表\t",
		 ...
		 new MenuItem("   清空列表歌曲\t",
				  ResourceManager.getViewOfClasspath("menu_clear.png")),
		 new MenuItem("   导入列表文件\t"),new MenuItem("   导出列表文件\t"))
	  .build();
   ...
   public void handle(ActionEvent event){
	 ...
	 List<File> files=chooser.showOpenMultipleDialog(ZPlayer.stage);
