...
public final class FrameWorkInternal
...
public FrameWorkInternal (FrameWorkBase fwb) {
...
public Object[] asyncRequest (FrameWorkParm Req )  {
...
public Object[] syncRequest (FrameWorkParm Req) {
	  ...
	  if  (nbr_que == 0) {
   	...
   	int waitime = Req.getTime(); 
		...
		//   This is for the appl thread to post. Java passes arrays by reference, so the
