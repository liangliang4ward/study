...
public final class FrameWorkInternalServer {
...
public FrameWorkInterface createServer() 
				throws Throwable {

		// starting	
		System.out.println("FrameWork Internal Server initializing");		
		...
		// the object 
		FrameWorkInternal fwi = new FrameWorkInternal(T);
				
		// set global object
		T.Ti = (FrameWorkInterface) fwi;		
		...
		// *--- all done message ---*	
		System.out.println("FrameWork Internal Server started successfully");
