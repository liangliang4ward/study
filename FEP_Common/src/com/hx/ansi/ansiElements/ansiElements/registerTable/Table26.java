 ...
 * @time：2013-3-25 下午06:30:33
 * @version 1.0 
 */

public class Table26 extends Table{
	
	private static final Logger log = Logger.getLogger(Table26.class);
...
//		NBR_UNREAD_ENTRIES=0;
	...
	public AnsiDataItem getIndex(AnsiDataItem ansiDataItem, Table table, AnsiContext context) {
		...
		ansiDataItem.count="01D3";//467=5+1+(1+460)
		return ansiDataItem;
	}
	/**
	 * 获取没一个数据项字节数
