...
public class PduUtils
{
	...
	//         for SMS-SUBMIT only
	public static final int TP_RD_MASK = 0xFB;

	public static final int TP_RD_ACCEPT_DUPLICATES = 0x00;

	public static final int TP_RD_REJECT_DUPLICATES = 0x04;

	// TP-MMS   xxxxx0xx = more messages for the MS
	//          xxxxx1xx = no more messages for the MS
	//          for SMS-DELIVER and SMS-STATUS-REPORT only
	public static final int TP_MMS_MASK = 0xFB;

	public static final int TP_MMS_NO_MESSAGES = 0x00;

	public static final int TP_MMS_MORE_MESSAGES = 0x04;
	...
	public static final int TP_SRI_NO_REPORT = 0x00;

	public static final int TP_SRI_REPORT = 0x20;

	// TP-SRR   xx0xxxxx = no status report (for SMS-SUBMIT only)
	//          xx1xxxxx = status report
	public static final int TP_SRR_MASK = 0xDF;
