...
import UI.Component.ButtonColumn;
import UI.Component.ImageIcon;
import UI.Component.JTextFieldU;
...
public class TrainFrame extends JInternalFrame {
	...
	public TrainFrame() {
		...
		listbox.getColumnModel().getColumn(0).setCellRenderer(
		...
		listbox.getColumnModel().getColumn(1).setCellRenderer(
				new TableCellRenderer() {
		   ...
		   listbox.getColumnModel().getColumn(1).setCellEditor(
				new TableCellEditor() {
					...
					public Component getTableCellEditorComponent(JTable table,
						...
						jf.addFocusListener(new FocusListener(){
							...
							public void focusLost(FocusEvent arg0) {
								// TODO Auto-generated method stub
								System.out.print(((JTextField)arg0.getComponent()).getText().toString());
								DBfactory.getDBfactory().updateSampleValue(((JTextFieldU)arg0.getComponent()).getUUid(), ((JTextField)arg0.getComponent()).getText().toString());
