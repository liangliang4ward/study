...
import graphic.util.GetConnecteddomain.Line;
...
public class ConnectedDomain {
	...
	public void addNewline(Line newline) {
		...
		this
				.setLeft(this.left > newline.start ? newline.start : this
						.getLeft());
	...
	public double[][] getBit() {
		if (bit == null)
			bit = new double[this.bot - this.top + 1][this.right - this.left + 1];
